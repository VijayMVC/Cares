    ...
    public static class EmployeeMapper
    {
        ...
        public static EmployeeBaseResponse CreateFrom(this ResponseModels.EmployeeBaseResponse source)
        {
            return new EmployeeBaseResponse
            {
                ...
                Regions = source.Regions.Select(x => x.CreateDropdownFrom()),
                SubRegions = source.SubRegions.Select(x => x.CreateDropdownFrom()),
                Cities = source.Cities.Select(x => x.CreateDropdownFrom()),
